...
Dark mode gives each folder a deep version of its original tint, lighter labels, dark sheet frames, and quieter glass highlights. Both themes share the translucent 50–75% front gradient, 22px backdrop blur, and 190% saturation so the artwork shows through the glass. Dark mode dims the blurred backdrop to keep light labels readable, with a fine rim and inset highlight. Actual project screenshots retain their original colours. Shared Blog and private-work illustrations use matching dark backgrounds, sheets, accent colours, and subtle highlights; the same palettes also apply to home-page writing cards and article covers. Light and print artwork keep their original palettes.
